...
// TODO trait bound should just be IdempotentValue
// TODO track provenance (by maintinaining order information?) so that we can
// better report errors even though this violates commutativity formally
// speaking it doesn't do this in a semantically meaningful way since the
// conflicting values are the same, just that their order coveys how they were
// passed in
