...
PTJ_SEED="deadbeefdeadbeefdeadbeefdeadbeef"
...
ptj sort --seed "$PTJ_SEED" "$WORKDIR/ptj-aa.psbt" >"$WORKDIR/ptj-aa-sorted.psbt"
ptj export-bip174 "$WORKDIR/ptj-aa-sorted.psbt" >"$WORKDIR/ptj-aa-bip174.psbt"
PTJ_AA=$(cat "$WORKDIR/ptj-aa-bip174.psbt")
...
ptj sort --seed "$PTJ_SEED" "$WORKDIR/ptj-alice-bob.psbt" >"$WORKDIR/ptj-alice-bob-sorted.psbt"
ptj export-bip174 "$WORKDIR/ptj-alice-bob-sorted.psbt" >"$WORKDIR/ptj-alice-bob-bip174.psbt"
PTJ_ALICE_BOB=$(cat "$WORKDIR/ptj-alice-bob-bip174.psbt")
