...
that all paths contain 3 inputs, 3 outputs, 29.997 BTC of outputs, and converge
...
verifying that all merge paths preserve the expected transaction content and
produce identical PSBTs after sorting with the same seed.
...
- decoded content: 3 inputs, 3 outputs, 29.997 BTC of outputs on every path
- sorted result signs, finalizes, broadcasts, and mines on regtest
