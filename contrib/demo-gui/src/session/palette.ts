...
export function paletteRegistry(): PaletteRegistry {
  return new Map();
}

export function paletteColor(registry: PaletteRegistry, key: string): string {
...
export function groupColorKey(group: { kind: string; key: string }): string | null {
