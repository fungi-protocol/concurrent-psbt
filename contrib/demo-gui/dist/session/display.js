...
const CONCURRENT_PSBT_FIELD_NAMES = {
    global: {
...
export function proprietaryFieldName(map, prefix, subtype) {
    if (prefix !== "concurrent-psbt" || subtype === null)
        return null;
    return CONCURRENT_PSBT_FIELD_NAMES[map][subtype] ?? null;
}
function rawKeymapEntries(map, mapKind, names) {
    const entries = [];
